...
- `dataset.csv`: 9,653 muestras de conducción humana.
- `supervised_model.joblib`: Modelo MLP de imitación.
- `rl_model.zip`: Modelo DQN campeón (406,458 pasos).
- `reward_fn.py`: Función de recompensa balanceada para velocidad y seguridad.
- `rl_model.actions.json`: Espacio de acciones discretas optimizado.
- `Entrega_Examen3_Documento_Diseno.md`: Este documento de análisis.
